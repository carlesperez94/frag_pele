...
def add_fragment_to_pdb(pdb_file, fragment_smi, atom_type_where_grow, atom_index_where_grow, output_filename,
                        bond_type="simple", ligand_chain="L"):
    """
    ...
    print("{} has been created".format(core_pdb_file))
    # Transform this PDB to a SMILE code
    core_pdb_smile = c2s.pdb_to_smile(core_pdb_file)
    print("CORE SMILE: {}".format(core_pdb_smile))
    ...
    print(atomicnum_of_selected_atom)
    ...
    new_smile = sj.add_fragment(fragment_smi, core_smile_as_list, selected_atom, bond_type)
    print("RESULTANT SMILE: {}".format(new_smile))
...
#add_fragment_to_pdb("4e20.pdb", "CC(=SO)(=SO)", "N", 2, "test_def_10.pdb", "simple")